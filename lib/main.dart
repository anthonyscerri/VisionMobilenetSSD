...
import 'package:pothole_detection/realtime/live_camera.dart';
import 'package:pothole_detection/staticimage/static_delete.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Pothole Detector Prototype"),
        actions: <Widget>[
          IconButton(
